              ...
              for(var j=0;j<ordered_cmps.length;j++){
                  if(ordered_cmps[j].id===ordered_cmps[i].id){
                    ...
                    ordered_cmps[i].style.animationDuration="";
                     ...
                     container.querySelector('#name'+ordered_cmps[i].id).style.left=(0.4*width)/(ordered_cmps.length-1)*j+'px';/*'calc((40%/'+(ordered_cmps.length-1)+')*'+j+')';*/
                    ...
                    ordered_cmps[j].style.animationDuration="1s";
                     ...
                     container.querySelector('#name'+ordered_cmps[j].id).style.left=(0.4*width)/(ordered_cmps.length-1)*j+'px';//'calc((40%/'+(ordered_cmps.length-1)+')*'+j+')';
                    ...
                    if(j>i){
                      ...
                      container.querySelector('#name'+ordered_cmps[j].id).style.left=ordered_cmps[j].style.marginLeft;
              ...
              for(var j=0;j<ordered_cmps.length;j++){
                  if(ordered_cmps[j].id===ordered_cmps[i].id){
                    ordered_cmps[i].style.width=0.9*width+'px';
                     ...
                     container.querySelector('#name'+ordered_cmps[i].id).style.left=(0.1*width)/(ordered_cmps.length-1)*j+'px';//'calc((10%/'+(ordered_cmps.length-1)+')*'+j+')';
                     bigComponent=ordered_cmps[i].id;
                     clearTimeout(this.timeout);
                    ...
                    if(j<i){
                     ...
                     container.querySelector('#name'+ordered_cmps[j].id).style.left=(0.1*width)/(ordered_cmps.length-1)*j+'px';//'calc((10%/'+(ordered_cmps.length-1)+')*'+j+')';
